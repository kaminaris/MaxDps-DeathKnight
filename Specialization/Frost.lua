...
function Frost:precombat()
    if MaxDps:HasOnUseEffect('13') and (talents[classtable.PillarofFrost] and not talents[classtable.BreathofSindragosa] and (math.fmod(MaxDps:CheckTrinketCooldown('13').duration , cooldown[classtable.PillarofFrost].duration) == 0) or talents[classtable.BreathofSindragosa] and (math.fmod(cooldown[classtable.BreathofSindragosa].duration , MaxDps:CheckTrinketCooldown('13').duration) == 0)) then
        trinket_1_sync = 1
    else
        trinket_1_sync = 0.5
    end
    if MaxDps:HasOnUseEffect('14') and (talents[classtable.PillarofFrost] and not talents[classtable.BreathofSindragosa] and (math.fmod(MaxDps:CheckTrinketCooldown('14').duration , cooldown[classtable.PillarofFrost].duration) == 0) or talents[classtable.BreathofSindragosa] and (math.fmod(cooldown[classtable.BreathofSindragosa].duration , MaxDps:CheckTrinketCooldown('14').duration) == 0)) then
        trinket_2_sync = 1
    else
        trinket_2_sync = 0.5
    end
    ...
    if not trinket_1_buffs and trinket_2_buffs and (MaxDps:HasOnUseEffect('14') or not MaxDps:HasOnUseEffect('13')) or trinket_2_buffs and ((MaxDps:CheckTrinketCooldown('14').duration%trinket_2_duration)*(1.5 + MaxDps:HasBuffEffect('14', 'strength'))*(trinket_2_sync)*(1+((MaxDps:CheckTrinketItemLevel('14') - MaxDps:CheckTrinketItemLevel('13'))%100)))>((MaxDps:CheckTrinketCooldown('13').duration%trinket_1_duration)*(1.5 + MaxDps:HasBuffEffect('13', 'strength'))*(trinket_1_sync)*(1+((MaxDps:CheckTrinketItemLevel('13') - MaxDps:CheckTrinketItemLevel('14'))%100))) then
        trinket_priority = 2
    else
...
function Frost:callaction()
    ...
    if (MaxDps:CheckSpellUsable(classtable.trinket1, 'trinket1')) and (not (0 >0) and trinket_1_buffs and not trinket_1_manual and ((not trinket_2_buffs and buff[classtable.BreathofSindragosaBuff].up or not talents[classtable.BreathofSindragosa] or trinket_2_buffs) and buff[classtable.PillarofFrostBuff].remains >trinket_1_duration%2) and (not MaxDps:HasOnUseEffect('14') or MaxDps:CheckTrinketCooldown('14').remains or trinket_priority == 1)) and cooldown[classtable.trinket1].ready then
        MaxDps:GlowCooldown(classtable.trinket1, cooldown[classtable.trinket1].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket2, 'trinket2')) and (not (0 >0) and trinket_2_buffs and not trinket_2_manual and ((not trinket_1_buffs and buff[classtable.BreathofSindragosaBuff].up or not talents[classtable.BreathofSindragosa] or trinket_2_buffs) and buff[classtable.PillarofFrostBuff].remains >trinket_2_duration%2) and (not MaxDps:HasOnUseEffect('13') or MaxDps:CheckTrinketCooldown('13').remains or trinket_priority == 2)) and cooldown[classtable.trinket2].ready then
        MaxDps:GlowCooldown(classtable.trinket2, cooldown[classtable.trinket2].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket1, 'trinket1')) and (0 >0 and trinket_1_buffs and not trinket_1_manual and not buff[classtable.PillarofFrostBuff].up and (not talents[classtable.BreathofSindragosa] or not buff[classtable.BreathofSindragosaBuff].up and RunicPower >breath_rp_threshold and ((buff[classtable.PillarofFrostBuff].remains >6 or cooldown[classtable.PillarofFrost].ready) and sending_cds)) and (not MaxDps:HasOnUseEffect('14') or MaxDps:CheckTrinketCooldown('14').remains or trinket_priority == 1) or trinket_1_duration >= ttd and MaxDps:boss()) and cooldown[classtable.trinket1].ready then
        MaxDps:GlowCooldown(classtable.trinket1, cooldown[classtable.trinket1].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket2, 'trinket2')) and (0 >0 and trinket_2_buffs and not trinket_2_manual and not buff[classtable.PillarofFrostBuff].up and (not talents[classtable.BreathofSindragosa] or not buff[classtable.BreathofSindragosaBuff].up and RunicPower >breath_rp_threshold and ((buff[classtable.PillarofFrostBuff].remains >6 or cooldown[classtable.PillarofFrost].ready) and sending_cds)) and (not MaxDps:HasOnUseEffect('13') or MaxDps:CheckTrinketCooldown('13').remains or trinket_priority == 2) or trinket_2_duration >= ttd and MaxDps:boss()) and cooldown[classtable.trinket2].ready then
        MaxDps:GlowCooldown(classtable.trinket2, cooldown[classtable.trinket2].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket1, 'trinket1')) and (not trinket_1_buffs and not trinket_1_manual and (damage_trinket_priority == 1 or (not MaxDps:HasOnUseEffect('14') or MaxDps:CheckTrinketCooldown('14').remains)) and ((0 >0 and (not talents[classtable.BreathofSindragosa] or not buff[classtable.BreathofSindragosaBuff].up or not breath_dying) and not buff[classtable.PillarofFrostBuff].up or not (0 >0)) and (not trinket_2_buffs or cooldown[classtable.PillarofFrost].remains >20) or not talents[classtable.PillarofFrost]) or MaxDps:boss() and ttd <15) and cooldown[classtable.trinket1].ready then
        MaxDps:GlowCooldown(classtable.trinket1, cooldown[classtable.trinket1].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.trinket2, 'trinket2')) and (not trinket_2_buffs and not trinket_2_manual and (damage_trinket_priority == 2 or (not MaxDps:HasOnUseEffect('13') or MaxDps:CheckTrinketCooldown('13').remains)) and ((0 >0 and (not talents[classtable.BreathofSindragosa] or not buff[classtable.BreathofSindragosaBuff].up or not breath_dying) and not buff[classtable.PillarofFrostBuff].up or not (0 >0)) and (not trinket_1_buffs or cooldown[classtable.PillarofFrost].remains >20) or not talents[classtable.PillarofFrost]) or MaxDps:boss() and ttd <15) and cooldown[classtable.trinket2].ready then
        MaxDps:GlowCooldown(classtable.trinket2, cooldown[classtable.trinket2].ready)
    end
    if (MaxDps:CheckSpellUsable(classtable.main_hand, 'main_hand')) and (buff[classtable.PillarofFrostBuff].up or (trinket_1_buffs and trinket_2_buffs and (MaxDps:CheckTrinketCooldown('13').remains <cooldown[classtable.PillarofFrost].remains or MaxDps:CheckTrinketCooldown('14').remains <cooldown[classtable.PillarofFrost].remains) and cooldown[classtable.PillarofFrost].remains >20) or MaxDps:boss() and ttd <15) and cooldown[classtable.main_hand].ready then
